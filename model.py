...
class cyclegan(object):
    ...
    def _build_model(self):
        ...
        self.DB_real = self.discriminator(self.real_B, self.options, reuse=True, name="discriminatorB",update_collection="NO_OPS")
        self.DA_real = self.discriminator(self.real_A, self.options, reuse=True, name="discriminatorA",update_collection="NO_OPS")
